...
func (s *Service) OrderCreate(ctx context.Context, req *servicepb.OrderCreateRequest) (*servicepb.OrderCreateResponse, error) {
	...
	fmt.Println("req.Info.Items", req.Info.Items)
...
func (s *Service) StockInfo(ctx context.Context, req *servicepb.StocksInfoRequest) (*servicepb.StocksInfoResponse, error) {
